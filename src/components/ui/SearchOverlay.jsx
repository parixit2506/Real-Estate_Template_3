...
const SearchOverlay = ({ isOpen, onClose, searchQuery, setSearchQuery }) => {
	...
	return (
		<div
			ref={overlayRef}
			className="fixed inset-0 z-[10001] invisible opacity-0 bg-luxury-black/98 backdrop-blur-2xl flex items-start justify-center pt-[8vh] sm:pt-[15vh] px-4 sm:px-12"
		>
			<button
				onClick={onClose}
